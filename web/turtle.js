var Turtle = function (id) {
    ...
    this.originx = elem.offsetWidth / 2;
    this.originy = elem.offsetHeight / 2;
    this.clear();
};
...
Turtle.prototype.drawTo = function (x, y) {
    this.paper.path(Raphael.format("M{0},{1}L{2},{3}", this.x, this.y, x, y)).attr({
...
Turtle.prototype.forward = function (d) {
    ...
    if (this.pen) this.drawTo(newx, newy);
    this.x = newx;
    this.y = newy;
    this.updateTurtle();
};
